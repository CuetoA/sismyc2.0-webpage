...
String R9 = "08,";  // Hora (hh)
String R10 = "47,"; // Hora (mm)
String R11 = "25,"; // T°
String R12 = "95,"; // Humedad
String R13 = "13,"; // Nutrientes (N)
String R14 = "13,"; // Nutrientes (P)
String R15 = "13,"; // Nutrientes (K)
String R16 = "7";   // pH
